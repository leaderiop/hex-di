 ...
 */
import { describe, it, expect, vi, screen, fireEvent, waitFor, render, TestGraphBuilder, createMockAdapter, beforeEach, } from "./setup.js";
import { createContainer } from "@hex-di/runtime";
import { appGraph } from "../src/di/graph.js";
import { MessageStorePort, UserSessionPort, LoggerPort, ConfigPort, } from "../src/di/ports.js";
...
function createInspectableMessageStore() {
    ...
    return {
        ...
        listeners,
        store: {
            getMessages: vi.fn(() => Object.freeze([...messages])),
...
describe("User Switching", () => {
    ...
    it("should send messages as the currently logged-in user", async () => {
        ...
        render(_jsx(ContainerProvider, { container: container, children: _jsx(ChatRoom, {}) }));
        // =========================================================================
...
//# sourceMappingURL=user-switching.test.js.map