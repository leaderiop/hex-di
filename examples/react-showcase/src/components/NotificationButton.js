...
export function NotificationButton() {
    ...
    return (_jsxs("div", { className: "flex flex-col gap-2", children: [_jsx("button", { type: "button", onClick: handleClick, className: "rounded-lg bg-purple-500 px-4 py-2 font-medium text-white transition-colors hover:bg-purple-600 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2", "aria-label": "Send notification", children: "Send Notification" }), instance !== null && (_jsxs("p", { className: "text-sm text-gray-600", children: ["Instance #", instance.instanceId, " created at ", formattedTime] })), toast.visible && (_jsx("div", { "data-testid": "notification-toast", className: "fixed bottom-4 right-4 rounded-lg bg-purple-600 px-4 py-3 text-white shadow-lg", role: "alert", children: _jsx("p", { children: toast.message }) }))] }));
}
